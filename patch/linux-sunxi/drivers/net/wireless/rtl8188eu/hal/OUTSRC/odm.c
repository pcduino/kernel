	...
	)
{
	...
	//printk("HighRSSIThreshForRA:%d,LowRSSIThreshForRA:%d",HighRSSIThreshForRA,LowRSSIThreshForRA);
	//printk("==>%s,pRATRState:0x%02x RATRState:0x%02x ,RSSI:%d \n",__FUNCTION__,*pRATRState,RATRState,RSSI);
