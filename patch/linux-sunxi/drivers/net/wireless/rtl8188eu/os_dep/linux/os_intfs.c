...
int rtw_if2_fix_rate = 0xff;
int rtw_channel = 1;//ad-hoc support requirement 
int rtw_wireless_mode = WIRELESS_11BG_24N;
int rtw_vrtl_carrier_sense =1;//AUTO_VCS;// ENABLE_VCS;//AUTO_VCS;
int rtw_vcs_type = 2;//RTS_CTS;//2;//RTS_CTS;//*
...
_adapter *rtw_drv_if2_init(_adapter *primary_padapter, void (*set_intf_ops)(struct _io_ops *pops))
{
	...
	padapter->dir_dev = NULL;
	padapter->fix_rate = rtw_if2_fix_rate;
	res = _SUCCESS;
